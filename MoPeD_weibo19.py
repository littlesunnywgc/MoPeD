...
parser.add_argument('--fc3_in_features', type=int, default=1448, help='Number of output features for fc3')
...
parser.add_argument('--kl_in_features', type=int, default=430, help='Number of input features for kl')
...
class resnet50():
    def __init__(self):
        ...
        self.path = os.path.dirname(os.getcwd()) + '/dataset/weibo19/weibo_images/weibo_images_all/'
...
class MoPeD(NeuralNetwork):
    ...
    def forward(self, X_tid, X_text,image_features, text_features):
        ...
        att_feature = torch.cat( (w_unimodel * self_i, w_mutimodel * co_att_ti, w_mutimodel * co_att_it, w_unimodel * self_t), dim=1)
...
def load_dataset():
    pre = os.path.dirname(os.getcwd()) + '/dataset/weibo19/weibo_files'
    ...
    with open(pre + "/train_features_label.pkl", 'rb') as f:
    ...
    with open(pre + "/dev_features_label.pkl", 'rb') as f:
    ...
    with open(pre + "/test_features_label.pkl", 'rb') as f:
    ...
    mid2num = {}
    for file in os.listdir('../dataset/weibo19/weibocontentwithimage/original-microblog/'):
